...
Para distinguir entre el sistema representado por las ecuaciones $I$ y $II$ versus el sistema representado por las ecuaciones $i$ y $ii$, el primero se llama un **$VAR$ estructural** y el segundo se llama un **$VAR$ estándar**. 
