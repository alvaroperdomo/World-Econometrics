...
[^2]: **La ortogonalización implica que los efectos de los shocks en una variable se descomponen de manera que sean independientes de los efectos de los shocks en las demás variables del sistema. Esto permite una interpretación más clara de cómo un shock en una variable en particular afecta a todas las demás, ya que elimina la influencia directa de los shocks en las otras variables. En resumen, los coeficientes impulso-respuesta ortogonalizados proporcionan una representación de cómo las variables en un sistema VAR responden a los shocks en otras variables, teniendo en cuenta las relaciones de causalidad entre ellas y asegurando que los efectos sean mutuamente independientes, lo que facilita la interpretación y el análisis de la dinámica del sistema.**
