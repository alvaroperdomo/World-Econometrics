...
|--------------------------------------------------------------------------------------------------------------|:-------------------------------------:|:------------------------------------:|
| 1. ¿Qué es un modelo VAR? ¿Cuáles son los tipos de modelos VAR? y ¿Cómo hacer pronósticos con un modelo VAR? |  [X](Seccion02_02_ADF_T/Readme.md)    | [X](Seccion02_02_ADF_R/Readme.md)    | 
