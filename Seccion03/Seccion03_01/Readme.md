...
| **3.1.2.** Pruebas de Hipótesis de Modelos $VAR$                                                                                                                           |  [X](Seccion03_01_02_T/Readme.md)    | [X](Seccion03_01_02_R/Readme.md)     |
...
| [Sección: 3. Análisis Multivariado de Series de Tiempo](../Readme.md) |[Siguiente Subsección: 3.2. Cointegración y Estimación de Modelos _VEC_](../Seccion03_02/Readme.md) |
|-----------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
