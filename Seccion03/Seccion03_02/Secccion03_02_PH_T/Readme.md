...
* $c$ el número de parámetros estimados en cada ecuación del sistema no restringido [en el ejemplo que nos ocupa, $c=1+3n$  ya que cada ecuación del modelo no restringido tiene $3$ rezagos para cada variable más un intercepto], y
