...
Primero se tiene que crear una matriz en donde se recree la presencia de la endógeneidad. Por ejemplo, asuma que esta estimando un modelo "VEC" con tres variables y queremos saber si la segunda variable es exógena, entonces proponemos la siguiente matriz (3x2) que hemos llamada Matriz_A: [^1]
