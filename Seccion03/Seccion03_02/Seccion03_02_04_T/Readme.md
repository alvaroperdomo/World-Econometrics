...
## ¿Por qué se recomienda no hacer pruebas de causalidad de Granger y de exogeneidad en los modelos los $VEC$?
...
1. **¿Por qué Sims, Stock y Watson (1990) recomiendan no hacer pruebas de causalidad de Granger y de exogeneidad en los modelos los $VEC$?**
   ...
   c) Porque el $VEC$ puede incluir series estacionarias.
