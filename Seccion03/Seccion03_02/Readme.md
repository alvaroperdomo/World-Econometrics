...
## SUBSECCIÓN 3.2
# Cointegración y Estimación de Modelos de Vectores de Corrección de Errores (_VEC_)
...
|[Subsección anterior: 3.1. Estimación de Modelos _VAR_](../Seccion03_01/Readme.md) | [Sección: 3. Análisis Multivariado de Series de Tiempo](../Readme.md) |
|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------|
