...
Por otro lado, observe que cuando se tiene $a_1=1$ y $a_0=0$, entonces $y_t=y_{t-1}+\varepsilon_t$. Por lo tanto, se tiene $\Delta y_t=\varepsilon_t$, o equivalentemente, $y_t=y_0 \displaystyle\sum_{i = 0}^{t-1}\varepsilon_{t-i}$. En este caso, se dice que $y_t$ sigue un **paseo aleatorio**, en donde no se puede predecir con certeza, partiendo de $y_0$, si la secuencia { $y_t$ } va a subir o va a bajar con respecto al $y_0$ inicial.
...
| [Sección: 2 - Análisis Univariado de Series de Tiempo](../Readme.md) |[Siguiente Subección: 2.2. Pruebas de Raíz Unitaria](../Seccion02_02/Readme.md) |
|----------------------------------------------------------------------|--------------------------------------------------------------------------------|
