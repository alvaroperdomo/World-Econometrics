...
## SUBSECCIÓN 2.3:
# Análisis _ARMA_ (La Metodología de Box-Jenkins)
...
| [Anterior Subsección: 2.2. Pruebas de Raíz Unitaria](../Seccion02_02/Readme.md) | [Sección 2 - Análisis Univariado de Series de Tiempo](../Readme.md) |
|---------------------------------------------------------------------------------|---------------------------------------------------------------------|
