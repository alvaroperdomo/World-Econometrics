...
| [Anterior Subsección: 2.3.2. Estimando un _ARMA_ - Ejemplo simulado](../Seccion02_02/Readme.md) | [Subección 2.3 - Análisis _ARMA_ (La Metodología de Box-Jenkins)](../Readme.md) |
|-------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|
