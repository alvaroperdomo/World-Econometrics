...
1. **¿Cuál argumento y en cuál comando se le permite hacer gráficos de diagnóstico sobre los residuos estimados?:**
...
| [Subsección 2.2. Pruebas de Raíz Unitaria](../Readme.md) | [Subsección 2.2.1.(T). Explicación general de las pruebas _DF_ y _ADF_](../Seccion02_02_01_T/Readme.md)  |
|----------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
