...
## El problema con la potencia de las pruebas $DF$ y $ADF$
...
Dado que las pruebas $DF$ y $ADF$ estan sesgadas hacía el no rechazo de la hipótesis nula $\gamma=0$. Es aconsejable complementar el análisis de raíz unitaria con hipótesis de más potencia (como la prueba $ADF-GLS$) o que tengan el sesgo opuesto (como la prueba $KPSS$). 
...
| [Subsección 2.2. Pruebas de Raíz Unitaria](../Readme.md) | [Subsección 2.2.1.(R) Aplicando las pruebas _DF_ y _ADF_ en _R_ de ](../Seccion02_02_01_R/Readme.md) |
|----------------------------------------------------------|------------------------------------------------------------------------------------------------------|
