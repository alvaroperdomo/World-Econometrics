...
|[Anterior Subsección: 2.1. Series Estacionarias y No Estacionarias](../Seccion02_01/Readme.md)|[Sección 2 - Análisis Univariado de Series de Tiempo](Seccion02/Readme.md)|[Siguiente Subsección: 2.3. Análisis ARMA (Metodología de Box Y Jenkins)](../Seccion02_03/Readme.md) |
|----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|------------------------------------------------------------------------|
