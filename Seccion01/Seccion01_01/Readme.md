...
| [Siguiente Sección: 02. Los Indicadores de Desarrollo Económico del Banco Mundial](../Seccion01_02/README.md) | [:house: Inicio](https://github.com/alvaroperdomo/World-Econometrics/tree/main/README.md) |
|----------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
