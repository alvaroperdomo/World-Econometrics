...
| [Sección 1 - Las Series de Tiempo, _R_ y los _Indicadores de Desarrollo Mundial_](../Readme.md) | [Siguiente Sección: 1.2. R y los _Indicadores de Desarrollo Mundial_](../Seccion01_02/README.md) |
|-------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|
