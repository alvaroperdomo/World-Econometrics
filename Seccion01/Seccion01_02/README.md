## SECCIÓN 1.2: 
# R y los Indicadores de Desarrollo Mundial
...
La Base de Datos con los _Indicadores de Desarrollo Mundial_ pueden consultarse en https://datos.bancomundial.org/.
Si se desea tener un acceso rápido a la misma utilizando $R$ se puede descargar la libreria **WDI** escribiendo el siguiente comando en $RStudio$:
