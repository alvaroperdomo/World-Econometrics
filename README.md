...
| **2.2.5.** Ejemplo utilizando la base de datos _Indicadores de Desarrollo Mundial_ (primera parte) | Aplicación en $R$                                           |                           | 
...
| **2.3.3.** Ejemplo utilizando la base de datos _Indicadores de Desarrollo Mundial_ (segunda parte) | Aplicación en $R$                                           |                           | 
